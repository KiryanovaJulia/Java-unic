...
public class MapThis {
    public static void main(String[] args) {
        ...
        names.put("Кирянова", "Юлия");
        names.put("Горелик", "Маргарита");
        names.put("Погорелик", "Георгий");
        names.put("Гавриков", "Виктор");
        names.put("Чугаев", "Артем");
        names.put("Негребецкая", "Дарья");
        names.put("Маклашов", "Сева");
